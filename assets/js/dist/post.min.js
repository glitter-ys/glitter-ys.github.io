...
(function () {
  ...
  class Config {
    ...
    _mergeConfigObj(config, element) {
      ...
      return _objectSpread2(_objectSpread2(_objectSpread2(_objectSpread2({}, this.constructor.Default), typeof jsonConfig === 'object' ? jsonConfig : {}), isElement$1(element) ? Manipulator.getDataAttributes(element) : {}), typeof config === 'object' ? config : {});
    }
  ...
  const EVENT_SHOW$1 = "show".concat(EVENT_KEY);
  const EVENT_SHOWN$1 = "shown".concat(EVENT_KEY);
  const EVENT_HIDE$1 = "hide".concat(EVENT_KEY);
  const EVENT_HIDDEN$1 = "hidden".concat(EVENT_KEY);
  ...
  */
  ...
  class Tooltip extends BaseComponent {
    ...
    _getPopperConfig(attachment) {
      ...
      return _objectSpread2(_objectSpread2({}, defaultBsPopperConfig), execute(this._config.popperConfig, [undefined, defaultBsPopperConfig]));
    }
    _setListeners() {
  ...
  function ensureDownload(container, displayTitle, qrWrapper) {
    ...
    downloadLink.dataset.filename = "".concat(safeTitle, "-qrcode.png");
  ...
  function buildQrDownloadDataUrl(qrWrapper, title) {
    ...
    const titleFont = "600 ".concat(fontSize, "px ").concat(getDownloadFontFamily());
    const lines = [];
    ...
    const headerHeight = headerLineHeight ;
    const width = textWidth + padding * 2;
    const height = padding + headerHeight + (gap ) + source.height + (lines.length ? gap + textHeight : 0) + padding;
    ...
    let cursorY = padding;
    {
      ctx.font = "500 ".concat(headerFontSize, "px ").concat(getDownloadFontFamily());
